...
translations = {
    'de': {
        ...
        'confirm_clear_queue': 'Möchten Sie wirklich alle ausstehenden und fehlgeschlagenen Aufgaben aus der Warteschlange löschen?',
        'failed_clear_queue': 'Fehler beim Löschen der Warteschlange',
    ...
    'en': {
        ...
        'confirm_clear_queue': 'Are you sure you want to clear all pending and failed tasks from the queue?',
        'failed_clear_queue': 'Failed to clear queue',
